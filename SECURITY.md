...
- **Your audio stays on your computer.** The web app makes no network requests except to the
  instrument splitter on this computer at `127.0.0.1:8765` (and, in the local app, a heartbeat to itself). Anything that sends audio or data elsewhere is a bug.
