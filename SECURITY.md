...
- **Your audio stays on your computer.** The web app makes no network requests except to the
  optional local backend at `127.0.0.1:8765`. Anything that sends audio or data elsewhere is a bug.
...
- **The optional backend** listens on 127.0.0.1 only, accepts uploads up to 200 MB, and serves
